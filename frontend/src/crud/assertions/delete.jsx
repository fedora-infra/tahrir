    ...
    try {
      ...
      switch (error?.status) {
        case 400:
          ...
          break;
        case 401:
          expt = "Try authenticating before removing assertion";
          break;
        case 403:
          expt = "Ensure permissions are available";
          break;
        case 404:
          expt = "Badge, user, or assertion not found";
          break;
        case 500:
          expt = "Attempt removing assertion again later";
          break;
        default:
          expt = "Failed during assertion removal";
      }
